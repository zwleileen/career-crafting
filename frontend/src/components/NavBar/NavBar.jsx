  ...
  return (
    ...
    <nav className="w-full bg-[#1e2a38] py-12 px-4 relative">
        ...
        <div className="absolute left-4 md: bottom-3 flex items-center cursor-pointer space-x-2" >
            <Link 
            to="/home"
            className="text-white text-xs font-normal font-[DM_Sans] ml-2 hover:text-[#f9a825]"
            >
            Home
            </Link>
        ...
        <div className="absolute right-4 md:right-8 bottom-2 flex items-center cursor-pointer">
            ...
            className="text-white text-xs font-normal font-[DM_Sans] mr-2 hover:text-[#f9a825]"            >
            Sign Out
            </Link>
